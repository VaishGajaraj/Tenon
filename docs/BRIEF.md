...
`00-tenon-product-brief.md` (this) · `tenon-harness-spec.md` architecture + ADRs · `tenon-explainer-aug2026.md` how it works, sync design, demand evidence · `tenon-model-economics-aug2026.md` task→tier map, cost strategy · `tenon-audit-and-swarms-aug2026.md` audit findings, adopted patterns · `ai-workflow-tooling-thesis-aug2026.md` the market thesis · `launch-pick-red-team-aug2026.md` the gated 30-day plan · `gate1-outreach-kit-aug2026.md` discovery script, target list, battlecard · `gtm-stack-and-unify-aug2026.md` discovery tooling decisions, Unify read · `fpa-datarails-assessment-aug2026.md` the FP&A lane and the close-verification SKU · `tenon-interop-and-memory-aug2026.md` agent interop, memory, and what Tenon adopts · `00-archive-digest.md` closed directions and durable findings from the retired docs.
